...
import com.it.gmall.realtime.bean.TradePaymentWindowBean;
...
import com.it.gmall.realtime.util.TimestampLtz3CompareUtil;
...
/**
 * @author ZuYingFang
 * @time 2023-03-17 16:20
 * @description 交易域支付各窗口汇总表
 ...
 * 	                使用增量聚合函数,保留时间最大的一条数据,进行输出   用的少些
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<JSONObject> filterDS = jsonObjKeyedByDetailIdDS.process(new KeyedProcessFunction<String, JSONObject, JSONObject>() {
            ...
            public void onTimer(long timestamp, OnTimerContext ctx, Collector<JSONObject> out) throws Exception {
                ...
                out.collect(value);  // 获取状态中的值，此为最新的数据，将其写入流中
