 ...
 * @description 读取log日志流，过滤脏数据并做新老用户校验，之后将页面日志放到主流，启动、曝光、动作、错误放到侧输出流，并将其写入kafka的不同topic中
...
//        System.setProperty("HADOOP_USER_NAME", "xiaofang");
        ...
        DataStreamSource<String> kafkaDS = env.addSource(KafkaUtil.getKafkaConsumer("topic_log", "base_log_app"));
        ...
        SingleOutputStreamOperator<String> pageDS = jsonObjWithNewFlagDS.process(new ProcessFunction<JSONObject, String>() {
            ...
            public void processElement(JSONObject value, ProcessFunction<JSONObject, String>.Context ctx, Collector<String> out) throws Exception {
                ...
                if (start != null) {
                    ...
                    // 注意，只要不是启动日志，就肯定是页面日志，所以直接else就可以了
