...
import com.it.gmall.realtime.bean.TrafficPageViewBean;
...
//        System.setProperty("HADOOP_USER_NAME", "atguigu");
        ...
        DataStreamSource<String> ujDS = env.addSource(KafkaUtil.getKafkaConsumer(ujdTopic, groupId));
        DataStreamSource<String> pageDS = env.addSource(KafkaUtil.getKafkaConsumer(topic, groupId));

        //TODO 3.统一数据格式，将这几条流的数据包装为javabean
