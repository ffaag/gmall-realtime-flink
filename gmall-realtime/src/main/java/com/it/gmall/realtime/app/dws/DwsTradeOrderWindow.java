...
import com.it.gmall.realtime.bean.TradeOrderBean;
...
/**
 * @author ZuYingFang
 * @time 2023-03-17 18:12
 * @description  交易域下单各窗口汇总表
...
public class DwsTradeOrderWindow {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //TODO 5.针对 order_detail_id 进行去重(保留第一条数据即可)应对left join重复数据的问题
